    ...
    if (isAiring || isUpcoming || isLocal) {
      return Positioned(
        ...
        child: AnimatedContainer(
          ...
          width: (Manager.settings.hoverExpandAiringIndicator && widget.isHovered ? expanded * Manager.fontSizeMultiplier : size),
          height: size,
          ...
          child: AnimatedOpacity(
            opacity: Manager.settings.hoverExpandAiringIndicator && widget.isHovered ? 1 : 0,
            duration: shortDuration,
            child: Text(
              text,
