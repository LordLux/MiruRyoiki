...
class HoverableEpisodeTile2 extends StatefulWidget {
  ...
  @override
  State<HoverableEpisodeTile2> createState() => _HoverableEpisodeTileState2();
}

class _HoverableEpisodeTileState2 extends State<HoverableEpisodeTile2> {
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _isHovering
              ? [
                  BoxShadow(
                    // Hovering shadow under all the card
                            ...
                            return Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(ScreenUtils.kEpisodeCardBorderRadius - 4),
                                ),
                                child: Transform.translate(
                                  offset: const Offset(0, -1),
                                  child: Text(
                                    widget.uiEpisode.episodeNumber.toString(),
                ...
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Builder(builder: (context) {
                      ...
                      final fallbackTitle = 'Episode ${widget.uiEpisode.episodeNumber}';
                      final hasKnownTitle = text != fallbackTitle;
                    
                      // if (hasKnownTitle) text = "${widget.uiEpisode.episodeNumber} - $text";
                      // if (hasKnownTitle) text = text;
  ...
  void _showFutureMenu() {
    ...
    popUpContextMenu(Menu(items: [
      MenuItem(
        label: label,
        disabled: true, // TODO: implement OS notification reminder system
        onClick: (_) {},
      ),
    ]));
  }
