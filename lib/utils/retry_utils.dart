  ...
  static Future<T?> retry<T>(
    ...
    while (attempt <= maxRetries) {
      try {
        ...
        if (attempt > 0) {
          logInfo('${operationName ?? 'Operation'} succeeded after $attempt retries');
        }
    ...
    throw Exception('${operationName ?? 'Operation'} failed after $maxRetries retries. Last error: $lastError');
  }
